...
e.g.
     perl  SNP_Gene_Phenotype2haplotypes.pl  ./haplotypes.hmp   ./Phenotype.txt  ./test.gff  Si9g49990
USAGE
...
#system("cat  ../All_ann.hmp.head.txt hmp-$ARGV[3]-$Phenotype.1txt > hmp-$ARGV[3]-$Phenotype.txt");
...
system("rm -rf Plot_gene-$ARGV[3]-$Phenotype.R");
